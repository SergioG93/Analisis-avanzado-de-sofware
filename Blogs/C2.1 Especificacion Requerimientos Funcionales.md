...
|Secuencia Normal|Paso|Acción|
||1|Usuario ingresa a la plataforma.|
||2|Se registra en un curso.|
||3|Realiza la actividades determinadas por el curso.|
||4|Finaliza el curso con promedio de acreditacion.|
||5|La plafaroma genera una constancia al finalizar el curso.|
|:arrow_right:Post-condición|||
|:red_circle:Excepciones |Pasó|Acción|
||1|El usuario no alcanzo el puntaje de acreditacion.|
||2|Usuario se dio de baja durante el curso.|
||3|No hay conexion con la plataforma.|
||4|Se esta en proceso de evaluacion por parte del docente.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
