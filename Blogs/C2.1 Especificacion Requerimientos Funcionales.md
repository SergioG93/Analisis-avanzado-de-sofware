...
| Numero | Requerimiento | RFN-07| 
|---|---|---|
| Nombre | Consultas |
| Descripción | Visualización de la informacion de usuario, tareas y avances del curso asi como las actualizaciones que se vayan generando. |
| :bookmark_tabs:Pre-Condiciones | RFN-02 para ingreso a la plataforma y RFN-05 para revisar informacion del curso.  |
|Secuencia Normal|Paso|Acción|
||Número 1|Usuario ingresa a la plataforma.|
||Número 2|Selecciona en el menu principal la opcion cursos.|
||Número 3|Dentro de la lista mis cursos selecciona el que desea revisar.|
||Número 4|Se ingresa al curso deseado.|
||Número 5|Ingresa a la pestaña informacion para desplegar informacion.| 
|:arrow_right:Post-condición|El usuario sera capaz de revisar sus avances y el progreso que ha logrado.||
|:red_circle:Excepciones |Pasó|Acción|
||Número 1|No hay cursos registrados.|
||Número 2|Se pierde la conexion con la plataforma.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
