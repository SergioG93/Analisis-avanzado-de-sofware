...
|Secuencia Normal|Paso|Acción|
||1|Se ingresa a la plataforma.|
||2|En el menu principal selecciona la opcion foro.|
||3|Seleccion de tema para acceder a ls publicaciones|
|:arrow_right:Post-condición|El usuario podra visualizar temas que otros usuarios publiquen.||
|:red_circle:Excepciones |Pasó|Acción|
||1|Se pierde la conexion con la plataforma.|
||2|No existen publicaciones en la categoria deseada.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
