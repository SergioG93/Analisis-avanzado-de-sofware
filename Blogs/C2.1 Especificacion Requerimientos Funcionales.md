...
||Número 2|Selecciona la opción ingresar.|
||Número 3|Ingreso de datos correo y contraseña.|
||Número 4|Se ingresa a la plataforma.|
...
||Número 1|No existe registro previo.|
||Número 2|El administrador le ha impedido el acceso al usuario.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
...
|Secuencia Normal|Paso|Acción|
||Número 1|Ingresa a la plataforma.|
||Número 2| Se dirige a la sección del usuario.|
||Número 3|Despliegue de información de registro del usuario y datos.|
||Número 4|Presionar botón modificar para corregir información.|
||Número 5|Selección botón guardar para generar las modificaciones.|
|:arrow_right:Post-condición||Se registra nueva informacion, se actualiza perfil de usuario.|
|:red_circle:Excepciones |Paso|Acción|
||Número 1|El usuario no está registrado.|
||Número 2|Fallo de conexión con la BD no se realiza la modificación.|
||Número 3|Pérdida de conexión con con la plataforma.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
...
|Secuencia Normal|Paso|Acción|
||Número 1|Ingresar a la plafaroma.|
||Número 2|En el menú principal seleccionar la opción cursos.|
||Número 3|Seleccionar categorías.|
||Número 4|La plataforma despliega los cursos disponibles dentro de dicha categoría.|
|:arrow_right:Post-condición||El usuario podrá visualizar los cursos disponibles.|
|:red_circle:Excepciones |Paso|Acción|
||Número 1|El usuario selecciona otra opción del menú.|
||Número 2|No hay cursos disponibles dentro de la categoría.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
...
|Secuencia Normal|Paso|Acción|
||Número 1|El usuario ingresa a las categorías de los cursos.|
||Número 2|La plataforma mostrará el catálogo de cursos disponibles en la categoría.|
||Número 3|Se selecciona un curso y se muestran los datos así como la información de competencia y contenido.|
||Número 4|Selecciona la opción registrar en curso.|
||Número 5|Se procede al pago por concepto de inscripción.|
||Número 6|Se confirma la acción para actualizar usuario.|
|:arrow_right:Post-condición||El usuario queda registrado en el curso.|
|:red_circle:Excepciones |Paso|Acción|
||Número 1|No se puede concretar el pago.|
||Número 2|Curso sin disponibilidad.|
||Número 3|El usuario no confirma la inscripción.|
|:triangular_flag_on_post:Prioridad|
...
||Número 2|Selección de opción de cursos dentro del menú principal.|
||Número 3|Usuario deberá ingresar a mis cursos.|
||Número 4|Selecciona el curso que desea revisar dentro de la lista|
||Número 5|Dentro del contenido del curso seleccionar la actividad que desea revisar.|
|:arrow_right:Post-condición|Se le da la información sobre determinada actividad al usuario.||
|:red_circle:Excepciones |Paso|Acción|
||Número 1|No se encuentra el curso.|
||Número 2|La actividad ya no está disponible.|
||Número 3|No hay actividades dentro del curso.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
...
|Secuencia Normal|Paso|Acción|
||Número 1|Ingresa a la plataforma.|
||Número 2|Selecciona en el menú foro.|
||Número 3|Dentro del foro selección de la categoría.|
||Número 4|Dentro de la categoría seleccionar publicar.|
|:arrow_right:Post-condición|||
|:red_circle:Excepciones |Paso|Acción|
||Número 1|No hay conexión con la plataforma.|
||Número 2|Error al hacer la publicación.|
||Número 3|La publicación infringe las normas de comportamiento.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
...
|Secuencia Normal|Paso|Acción|
||Número 1|Usuario ingresa a la plataforma.|
||Número 2|Se registra en un curso.|
||Número 3|Realiza la actividades determinadas por el curso.|
||Número 4|Finaliza el curso con promedio de acreditacion.|
||Número 5|La plafaroma genera una constancia al finalizar el curso.|
|:arrow_right:Post-condición|||
|:red_circle:Excepciones |Pasó|Acción|
||Número 1|El usuario no alcanzo el puntaje de acreditacion.|
||Número 2|Usuario se dio de baja durante el curso.|
||Número 3|No hay conexion con la plataforma.|
||Número 4|Se esta en proceso de evaluacion por parte del docente.|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
