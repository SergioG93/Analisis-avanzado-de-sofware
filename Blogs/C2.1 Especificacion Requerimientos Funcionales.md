...
||Número 2|Selecciona en el menu foro|
||Número 3|Dentro del foro seleccion de la categoria.|
||Número 4|Dentro de la categoria seleccionar publicar.|
|:arrow_right:Post-condición|Quedara en la plataforma una publicacion del usuario.||
|:red_circle:Excepciones |Pasó|Acción|
||Número 1|No hay conexion con la plataforma.|
||Número 2|Error al hacer la publicacion.|
||Número 3|La publicacion inflije las normas de comportamiento|
|:triangular_flag_on_post:Prioridad|
|Alta/Esencial|Media:heavy_check_mark:|Baja|
